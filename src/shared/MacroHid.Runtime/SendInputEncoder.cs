...
public static class SendInputEncoder
{
    ...
    private static ushort MapKey(HidKey key)
    {
        ...
        return key switch
        {
            ...
            HidKey.NonUsHash => 0xDF,
            HidKey.NonUsBackslash => 0xE2,
            ...
            HidKey.NumpadEqual or HidKey.NumpadEqualSign => 0x92,
            HidKey.NumpadComma or HidKey.Separator => 0x6C,
